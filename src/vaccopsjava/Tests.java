...
public class Tests {
    ...
    @Test
    public void testGetDoctorsSort() {
        vaccOps.addDoctor(d1);
        vaccOps.addDoctor(d6);
        vaccOps.addDoctor(d3);
        vaccOps.addDoctor(d2);

        vaccOps.addPatient(d1,p1);
        vaccOps.addPatient(d1,p2);

        vaccOps.addPatient(d2,p3);
        vaccOps.addPatient(d2,p4);
        vaccOps.addPatient(d2,p5);

        vaccOps.addPatient(d6,p7);
        vaccOps.addPatient(d6,p9);
        vaccOps.addPatient(d6,p10);

        vaccOps.addPatient(d3,p8);

        Collection<Doctor> doctorsSortedByPatientsCountDescAndNameAsc = vaccOps.getDoctorsSortedByPatientsCountDescAndNameAsc();
        System.out.println();
